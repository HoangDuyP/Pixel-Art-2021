...
using System;
public class CreateMapMango : MonoBehaviour
{
    int dai = 45, rong = 29;
    public int maxPoint = 0;
    string AppleArraySave = String.Empty;
    string AppleArray2 = "";
    ...
    private void Start()
    {
        if (SaveSystem.LoadPictureMango() != null)
        {
            Debug.Log("load success");
            AppleArraySave = SaveSystem.LoadPictureMango();
        }
    ...
    public void Save_Picture()
    {
       ...
       SaveSystem.SavePictureMango(AppleArraySave);
    }
